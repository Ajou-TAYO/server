...
INSERT INTO partnership(category,name,detail,expired,lat,lng,image) values('BEAUTY','벨르 뷰티헤어', '대학생 커트 10,000원 / 남성 펌 35,000원 / 남성 커트+다운펌 20,000원 / 남성 염색 40,000원 / 여성 셋팅펌 - 숏: 4만원 미디움:6만원 롱:7만원 / 여성 염색 - 숏:48,000원 미디움:64,000원 롱:72,000원 / 펌 염색 시술 시 크리닉 서비스','12/31',37.2749461,127.044341,'	https://ajouchongmedia.s3.amazonaws.com/media/imag…%EB%A5%B4%EB%B7%B0%ED%8B%B0%ED%97%A4%EC%96%B4.jpg');
...
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('RESTAURANT','비담비','(1) 3인 이상 방문 시, 고기만두 1판 15000원에 제공, (2) 6인 이상 방문 시, 고기만두 2판 3000원에 제공','12/31',37.278642515801, 127.045644278408);
...
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('RESTAURANT','한마리 정육식당','계좌이체/현금결제 10% 할인(최대 할인 금액 3만원)', '12/31', 37.275475529302, 127.04520263001);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('PUB','804','계좌이체/현금결제 10% 할인','12/31', 37.27540113419, 127.04535762058);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('PUB','옥상포차','계좌이체/현금결제 10% 할인', '12/31',37.275279516434, 127.04529835251);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('PUB','셰프의 포차','계좌이체/현금결제 10% 할인','12/31', 37.2753201149375, 127.045163073663);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('HEALTH','언더독클라임','(1) 아주대 학생 암벽화&초크백 무료 대여, (2) 회원등록 시 10% 할인',  '12/31',37.266397538048, 127.031259802265);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('RESTAURANT','미스터쉐프','3인 이상 주문 시, 음료 제공', '12/31',37.279193201305, 127.042831288346);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('CAFE','더 머랭','마카롱 3개 주문 시, 꼬끄 후레이크 추가 제공 / 5개 주문 시, 1개 추가 제공', '12/31', 37.278959188907, 127.042112323039);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('RESTAURANT','떡슐랭','감자볼 튀김 제공', '12/31', 37.278959188907, 127.042112323039);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('RESTAURANT','이태리밥','10% 할인', '12/31', 37.279060121538, 127.043316073295);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('RESTAURANT','유가네 닭갈비','닭갈비 2인분 주문 시, 치즈or음료 1병 제공(세트메뉴 제외)', '12/31',37.279046658463, 127.043172298873);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('RESTAURANT','아롤도그','1만원 이상 계좌이체/현금결제 시, 캔음료 제공', '12/31', 37.27906680282, 127.04352467985);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('RESTAURANT','사랑집','테이블 당 볶음밥 1개 제공(타 이벤트 중복 가능)', '12/31',37.2788193238209, 127.04268167233);
INSERT INTO partnership(category,name,detail,expired,lat,lng) values('CAFE','디저트 39','(1) 아메리카노 20% 할인, (2) 코코넛 젤리/펄 무료 추가', '12/31', 37.27869964056, 127.04349346008);
